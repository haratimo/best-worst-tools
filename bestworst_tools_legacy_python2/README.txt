...
These scripts require Python 2.7 to run (3.0 untested). If you have not already
installed python, please download and install it! Most OSs come with Python2.7
pre-installed.
  http://www.python.org
...
For help:
  python scripts/create_trials.py -h
...
python scripts/create_trials.py samples/anew_words.txt > anew_bestworst_trials.csv
...
For help:
  python scripts/score_trials.py -h
...
python scripts/score_trials.py samples/aoa_raw_data/* > anew_aoa_scores.csv
...
For help:
  python scripts/flag_noncompliant_users.py -h
...
python scripts/flag_noncompliant_users.py anew_aoa_scores.csv samples/aoa_raw_data/* --id_column=uuid > anew_aoa_compliance.csv
...
python scripts/flag_noncompliant_users.py anew_aoa_scores.csv samples/aoa_raw_data/* --id_column=uuid --filter=0.60 > anew_aoa_trials_filtered.csv
...
python scripts/score_trials.py anew_aoa_trials_filtered.csv > anew_aoa_scores_filtered.csv
...
For help:
  python scripts/simulate_results.py -h
...
python scripts/simulate_results.py samples/simulation_input.csv 8000 4 --latentvalue=Normal > simulation_normal.csv
...
python scripts/simulate_results.py samples/simulation_input.csv 8000 4 --latentvalue=Normal --noise=0.5 > simulation_normal_noise0.5.csv
...
For help:
  python scripts/batch_simulate.py -h
...
python scripts/batch_simulate.py samples/simulation_input.csv --latentvalue=Normal --noise=0.0,0.5,1.0 --N=1000 --K=4 --num_simulations=100
...
For help:
  python scripts/aggregate_simulations.py -h
...
python scripts/aggregate_simulations.py simulations --dir=sim_aggregates
